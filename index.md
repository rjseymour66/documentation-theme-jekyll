---
title: This is a test I hope it works
...
The site should now be running at [http://localhost:4000/](http://localhost:4000/){: .cc-active}.
...
The sidebar data file uses a specific YAML syntax that you must follow. Follow the sample pattern shown in the theme, specically looking at mydoc\_sidebar.yml as an example: Here's a code sample showing all levels:
